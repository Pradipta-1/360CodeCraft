      ...
      <div className="app-container">
        <nav className="top-nav">
          ...
          <div className="nav-list">
            <Link
              href="/user/dashboard"
              className={`nav-item${pathname === '/user/dashboard' ? ' active' : ''}`}
            >
              Dashboard
            </Link>
            <Link
              href="/user/events"
              className={`nav-item${pathname === '/user/events' ? ' active' : ''}`}
            >
              Events
            </Link>
            <Link
              href="/user/trainers"
              className={`nav-item${pathname === '/user/trainers' ? ' active' : ''}`}
            >
              Trainers
            </Link>
            <Link
            ...
            <Link
              ...
              className={`nav-item${pathname === '/user/profile-settings' ? ' active' : ''}`}
            >
              Profile &amp; Settings
            </Link>
          </div>
